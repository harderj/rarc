...
export function wasm_bindgen__convert__closures__invoke1_mut__h175b26d83d173389(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__hf120794e26904fb8(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h1fddcfec0f49fd90(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h7b16f8c2ebc7af7f(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h82a68ee0334def39(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h5d5e8fdc34938e64(a: number, b: number): void;
